...
- 🗺 **Page unique Operator** (`/operator`, le HUD 8770 y redirige) — conversation voix + écrit, vie de l'assistant, automations, cerveau, CRM monday.com, file de validation 95/5 — **en local uniquement** ([docs/monday.md](docs/monday.md), [docs/panneau.md](docs/panneau.md))
